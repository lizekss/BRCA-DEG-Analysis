...
ამ ფიგურების სწორი ინტერპრეტაცია პროექტის განვრცობის ერთ-ერთი საინტერესო ვარიანტია, ვინაიდან აქამდე ფიგურებში ძირითადად კორელაციის აბსოლუტურ მნიშვნელობებს (მოდულებს) განვიხილავდით.
